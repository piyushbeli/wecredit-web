    ...
    <div className="min-h-screen bg-gray-50">
      {!isOpen && (
        <div className="flex flex-col items-center justify-center min-h-screen p-6">
          <h1 className="text-xl font-semibold text-gray-900 mb-2">Home Loan</h1>
          <p className="text-gray-600 text-center mb-6">
            Apply for a home loan to get the best offers from our partner lenders.
          </p>
      ...
      <HomeLoanFormModal isOpen={isOpen} onClose={closeModal} />
    </div>
  );
};
