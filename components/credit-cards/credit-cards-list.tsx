...
const CreditCardsList = (): React.ReactNode => {
  if (CREDIT_CARDS.length === 0) {
    return (
      <div className="px-4 my-4 lg:mt-20 max-w-6xl mx-auto flex min-h-[240px] items-center justify-center">
        <ComingSoonCard />
      </div>
    );
  }
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center px-4 my-4 lg:mt-20 max-w-6xl mx-auto">
